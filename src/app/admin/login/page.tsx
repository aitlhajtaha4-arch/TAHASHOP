      ...
      >
        <div className="rounded-3xl border border-white/40 bg-white/70 p-8 sm:p-10 shadow-[0_8px_60px_rgba(0,0,0,0.06),0_2px_20px_rgba(0,0,0,0.04)] backdrop-blur-2xl">
          ...
          >
            ...
            <p className="text-sm font-medium text-gray-400">لوحة الإدارة</p>
          </motion.div>
          ...
          {error && (
            <motion.div
              ...
              className="mb-5 rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-sm font-medium text-red-600 text-center"
            >
              {error}
            </motion.div>
          )}
